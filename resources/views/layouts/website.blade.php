      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-4 site-logo">
            <a href="http://127.0.0.1:8000/" class="text-black h2 mb-0">Mini Blog</a>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 text-center">
            <p>
              {{ $setting->copyright }}
              <div class="mb-0">Developed By CosmyCode on <a href="https://www.youtube.com/playlist?list=PLl4v4A2HI0YixTm5AsoTu-sKxiQti4-r6">Laravel Blog Development </a></div>
              </p>
          </div>
        </div>
      </div>
